...
let jsonMock = """
{"version":"https://jsonfeed.org/version/1","title":"GabTrends.com Feed","home_page_url":"https://trends.gab.com/","feed_url":"https://trends.gab.com/trend-feed","description":"Hourly updates from the people-powered newsroom.","icon":"https://trends.gab.com/img/social-card.jpg","author":{"name":"Gab.com","url":"https://gab.com/"},"items":[\(itemMock),\(itemMock),\(itemMock),\(itemMock),\(itemMock)]}
"""
let itemMock = """
